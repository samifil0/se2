Feature: Suggesties krijgen voor ingrediënten
    ...
    Zodat ik snel een geschikt ingrediënt kan toevoegen aan een recept.
    ...
    Scenario: Prijs raadplegen van een recept op datum van vandaag
        Given de dag van de suggestie is "2024-03-15"
        When ik 2 suggesties vraag voor de goedkoopste producten
        Then krijg ik een lijst van 2 producten gesorteerd op prijs // TODO: eigen suggestiefunctie checken
